...
type IdentifikasiRisikoStrategisOPD struct {
	...
	PenetapanKonteksRisikoStrategisRenstraOPDID *string   `json:"penetapan_konteks_risiko_strategis_renstra_opd_id"` // references penetapan_konteks_risiko_strategis_renstra_opd.id / form 2b
