...
func SetupDependency(mariaDB *gorm.DB, mux *http.ServeMux, jwtToken helper.JWTTokenizer, printer *helper.ApiPrinter, cj *cronjob.CronJob, sseDashboard *helper.SSE) {
	...
	identifikasiRisikoOperasionalOPDGetAllUseCase := usecase.ImplIdentifikasiRisikoOperasionalOPDGetAllUseCase(identifikasiRisikoOperasionalOPDGetAllGateway)
	identifikasiRisikoOperasionalOPDGetOneUseCase := usecase.ImplIdentifikasiRisikoOperasionalOPDGetByIDUseCase(identifikasiRisikoOperasionalOPDGetOneGateway)
	...
	identifikasiRisikoOperasionalOPDCreateUseCase := usecase.ImplIdentifikasiRisikoOperasionalOPDCreateUseCase(generateIdGateway, identifikasiRisikoOperasionalOPDCreateGateway, kategoriRisikoGetOneGateway, opdGetOneGateway, penetapanKonteksRisikoOperasionalGetOneGateway)
	identifikasiRisikoOperasionalOPDUpdateUseCase := usecase.ImplIdentifikasiRisikoOperasionalOPDUpdateUseCase(identifikasiRisikoOperasionalOPDGetOneGateway, identifikasiRisikoOperasionalOPDCreateGateway, kategoriRisikoGetOneGateway, rcaGetOneGateway, opdGetOneGateway, penetapanKonteksRisikoOperasionalGetOneGateway)
	identifikasiRisikoOperasionalOPDApprovalUseCase := usecase.ImplIdentifikasiRisikoOperasionalOPDApprovalUseCase(identifikasiRisikoOperasionalOPDGetOneGateway, identifikasiRisikoOperasionalOPDCreateGateway)
	...
	daftarRisikoPrioritasCreateUseCase := usecase.ImplDaftarRisikoPrioritasCreateUseCase(
		generateIdGateway,
		daftarRisikoPrioritasCreateGateway,
		identifikasiRisikoStrategisPemdaGetOneGateway,
		identifikasiRisikoOperasionalOPDGetOneGateway,
		identifikasiRisikoStrategisOPDGetOneGateway,
		penetapanKonteksRisikoStrategisPemdaGetOneGateway,
	...
	daftarRisikoPrioritasUpdateUsecase := usecase.ImplDaftarRisikoPrioritasUpdateUseCase(
		daftarRisikoPrioritasGetOneGateway,
		daftarRisikoPrioritasCreateGateway,
		identifikasiRisikoStrategisPemdaGetOneGateway,
		identifikasiRisikoOperasionalOPDGetOneGateway,
		identifikasiRisikoStrategisOPDGetOneGateway,
