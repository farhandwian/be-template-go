...
func (c Controller) DoorControlGetAllHandler(u usecase.DoorControlGetAll) helper.APIData {
	apiData := helper.APIData{
		Method:  http.MethodGet,
		Url:     "/dashboard/doorcontrol",
		Access:  iammodel.PINTU_AIR_DETAIL_PINTU_AIR_TABLE_DATA_JADWAL_PENGONTROLAN_PINTU_AIR_READ,
